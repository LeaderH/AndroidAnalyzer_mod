...
def getPlugins():
    ...
    for plugin_name in possibleplugins.keys():
        ...
        #info ::tuple(file, pathname, description)
...
def runAnalysis(classes,dependencies, sharedobjs):
    ...
    for i in getPlugins():
        ...
        #plugin.run(dependencies,classes,sharedobjs)  #original @4/11
        plugin.run(classes,dependencies,sharedobjs)
